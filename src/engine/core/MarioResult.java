...
public class MarioResult {
    ...
    /**Author for this function: Jan Niklas Schäfer
     *
     * get the final x position of mario inside the world
     *
     * @return the final x position of mario
     */
    public float getFinalMarioXPosition(){
        return this.world.mario.x;
    }
    /**Author for this function: Jan Niklas Schäfer
     *
     * get the sum of the overtime at the end of a level
     *
     * get the summed up overtime
     */
    public int getOvertimeSum() {return this.world.overtime;}
}
