...
public class MarioWorld {
    ...
    //The following 2 variables were added as part of Jan Niklas Schäfer's bachelor Thesis. Author: Jan Niklas Schäfer

    public int overtime = 0; //Variable to sum up the overtime per frame. If an agent on average takes longer than 40ms for a decision in a frame this will be positive, otherwise negative or zero

    public ArrayList<Float[]> drawCoordinates;  // Array to enable debug Draw. Each element consists of 4 different float values. The 1. and 2. represent the first coordinate pair, the 3. and 4. the second.
    ...
    public MarioWorld(MarioEvent[] killEvents) {
        ...
        this.drawCoordinates = new ArrayList<>();       //Added drawCoordinates Array to world object. Author: Jan Niklas Schäfer
    }
