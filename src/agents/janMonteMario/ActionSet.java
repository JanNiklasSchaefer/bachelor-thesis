...
public class ActionSet {
    ...
    public static final boolean[][] moveSetWithJump = {moveRight, moveLeft, fastJumpRight, fastJumpLeft, sprintRight, sprintLeft, slowJumpRight, slowJumpLeft, shoot, jump, doNothing, duck};
    public static final boolean[][] moveSetWithoutJump = {moveRight, moveLeft, sprintRight, sprintLeft, shoot, doNothing, duck};
    public static final boolean[][] moveSetWithoutShoot = {moveRight, moveLeft, fastJumpRight, fastJumpLeft, sprintRight, sprintLeft, slowJumpRight, slowJumpLeft, jump, doNothing};
