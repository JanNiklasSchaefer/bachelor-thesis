This README is taken from the MARIO-AI-FRAMEWORK.

URL: https://github.com/amidos2006/Mario-AI-Framework/tree/master/levels

The levels in all the sub-folders were also taken over from this framework. Except for flatLevel.txt. 

flatLevel.txt was used to record the speed and position data to determine the RBA heuristic.

The modification of the README ends here and the copy from the original GitHub begins.
